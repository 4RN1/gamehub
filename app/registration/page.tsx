...
const page = () => {
  ...
  <div className="flex justify-center items-center  min-h-screen bg-[url('/assets/bbb.jpg')] bg-cover">
      ...
      <div className="bg-[rgb(40,34,59)] w-215.5 h-150  rounded-[15px] flex z-10">
        {/* LEFT SIDE */}
        <div className="ml-3.75 mt-3.75 rounded-[15px] pl-5 pt-5 h-142.5 w-105 bg-[url('/assets/login-image.jpg')] brightness-95 bg-cover bg-center bg-no-repeat">
        ...
        <div className="bg-[rgb(40,34,59)] h-142.5 mt-3.75 w-105 pl-15 pt-12.5">
          <h1 className="text-white font-sans text-xl">შექმენით ანგარიში</h1>
          ...
          <div className="flex flex-col  mt-5">
            <input
              type="text"
              placeholder="Email"
              className="h-10 max-w-78 w-full rounded-xs border border-white  pl-2.5 bg-transparent text-white"
            />
            ...
            />
              ...
              className="h-10 max-w-78 w-full rounded-xs border border-white mb-5  pl-2.5 bg-transparent text-white"
            />
