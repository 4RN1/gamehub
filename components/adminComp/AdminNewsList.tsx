    ...
    <div>
      <div className="min-h-screen w-full bg-gray-100 text-gray-800 p-6 flex flex-col gap-5">
        ...
        <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-5 flex justify-between ">
          <div>
            ...
            <div className="flex gap-3 flex-wrap items-center">
              <input
                type="text"
                placeholder="Title"
                className="bg-white border border-gray-300 rounded-md text-sm text-gray-700 px-3 py-2 w-48 outline-none focus:border-blue-800 placeholder:text-gray-400"
              />
              <input
                type="text"
                placeholder="Status"
              ...
              <input
                ...
                className="bg-white border border-gray-300 rounded-md text-sm text-gray-700 px-3 py-2 w-48 outline-none focus:border-blue-800 placeholder:text-gray-400"
              />
              <button className="bg-blue-700 hover:bg-blue-800 text-white text-sm font-semibold px-5 py-2 rounded-md transition-colors">
                Filter
              </button>
              <button className="border border-blue-700 text-blue-500 hover:bg-blue-50 text-sm font-semibold px-5 py-2 rounded-md transition-colors">
                Clear
              </button>
            </div>
          </div>
          ...
          <Link
            href="/admin/add-news"
            className="bg-blue-700 hover:bg-blue-800 text-white text-sm font-semibold px-5 py-2 rounded-md transition-colors flex items-center gap-2"
          >
            <Plus /> Add News
          </Link>
        </div>
       ...
       <EditNewsModal open={editOpen} onclose={() => setEditOpen(false)} slug={editSlug} />
      </div>
    </div>
