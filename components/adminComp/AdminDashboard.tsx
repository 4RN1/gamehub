...
const QUICK_LINKS = [
  { label: "სიახლის დამატება", sub: "Add news", href: "/dashboard/add-news", iconBg: "bg-blue-50", iconColor: "text-blue-700", icon: "+" },
  { label: "სიახლეების სია", sub: "News list", href: "/dashboard/news-list", iconBg: "bg-green-50", iconColor: "text-green-700", icon: "≡" },
  { label: "შეტყობინებები", sub: "Support", href: "/dashboard/support", iconBg: "bg-red-50", iconColor: "text-red-700", icon: "✉" },
];
      ...
      <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <div className="bg-gray-50 rounded-lg p-4 flex flex-col gap-1 border border-zinc-300">
            ...
            <span className="text-2xl font-medium text-gray-900">{newsCount}</span>
          ...
          <div className="bg-gray-50 rounded-lg p-4 flex flex-col gap-1 border border-zinc-300">
            ...
            <span className="text-2xl font-medium text-gray-900">{ad}</span>
            <span className="text-sm text-gray-500">დონაციები / რეკლამები</span>
            <span className="text-sm font-medium text-amber-700 bg-amber-50 px-2 py-0.5 rounded-full w-fit mt-1">საცდელი</span>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 flex flex-col gap-1 border border-zinc-300">
            ...
            <span className="text-2xl font-medium text-gray-900">{supportCount}</span>
          ...
          <div className="bg-gray-50 rounded-lg p-4 flex flex-col gap-1 border border-zinc-300">
            ...
            <span className="text-2xl font-medium text-gray-900">{resolvedMsgCount}</span>
        ...
        <div className="bg-white border border-gray-200 shadow-sm rounded-xl overflow-hidden">
          ...
          <div>
            {QUICK_LINKS.map((link) => (
              ...
              >
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${link.iconBg}`}>
